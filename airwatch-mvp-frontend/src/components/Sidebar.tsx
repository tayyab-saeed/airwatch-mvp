...
export default function Sidebar() {
  return (
    <aside className="w-56 border-r border-gray-100 h-[calc(100vh-64px)] sticky top-0 bg-white">
      <div className="p-4 flex flex-col gap-6 h-full">
        <div className="flex items-center gap-2 px-2">
          <div className="w-9 h-9 rounded-full bg-eco-green-50 flex items-center justify-center text-eco-green-600">
